...
<div class="p-6 flex items-center justify-center min-h-screen">
    <div class="md:flex">
        <img
            src="assets/images/jess-archer.jpg"
            alt="Jess Archer"
            class="
