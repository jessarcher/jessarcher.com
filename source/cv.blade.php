    ...
    <div class="max-w-4xl mx-auto p-6 print:p-0 print:max-w-none">
        ...
        <div class="mt-6">
            <ul class="-m-1 flex flex-wrap font-semibold">
                ...
                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Vim</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Automated Testing</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">TDD</li>
                ...
                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">DevOps</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">APIs</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Open-source</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Privacy</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Security</li>
                ...
                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Scripting &amp; Automation</li>
                ...
                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">CI/CD</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">DNS</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Email Transport</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">IP Networking</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">UI/UX</li>

                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Troubleshooting</li>
                ...
                <li class="m-1 px-3 py-1 inline-flex items-center bg-indigo-200 text-indigo-800 rounded">Responsive Design</li>
            </ul>
        </div>
